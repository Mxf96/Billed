...
describe("I am connected as an Admin and I am on Dashboard Page", () => {
  describe("bill data is passed to DashboardUI", () => {
  ...
  describe("pending bill is passed to DashboardUI", () => {
  ...
  describe("accepted bill is passed to DashboardUI", () => {
  ...
  describe("refused bill is passed to DashboardUI", () => {
    test("Then, it should show admin commentary", () => {
