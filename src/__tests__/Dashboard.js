...
describe("I am connected as an Admin", () => {
  describe("I am on Dashboard page, there are bills, and there is one pending", () => {
    test("Then, filteredBills by pending status should return 1 bill", () => {
      const filtered_bills = filteredBills(bills, "pending");
      expect(filtered_bills.length).toBe(1);
    });
  });
  describe("I am on Dashboard page, there are bills, and there is one accepted", () => {
    test("Then, filteredBills by accepted status should return 1 bill", () => {
      const filtered_bills = filteredBills(bills, "accepted");
      expect(filtered_bills.length).toBe(1);
    });
  });
  describe("I am on Dashboard page, there are bills, and there is two refused", () => {
    test("Then, filteredBills by accepted status should return 2 bills", () => {
      const filtered_bills = filteredBills(bills, "refused");
      expect(filtered_bills.length).toBe(2);
    });
  });
  describe("I am on Dashboard page but it is loading", () => {
    test("Then, Loading page should be rendered", () => {
      document.body.innerHTML = DashboardUI({ loading: true });
      expect(screen.getAllByText("Loading...")).toBeTruthy();
    });
  });
  describe("I am on Dashboard page but back-end send an error message", () => {
  ...
  describe("I am on Dashboard page and I click on arrow", () => {
  ...
  describe("I am on Dashboard page and I click on edit icon of a card", () => {
  ...
  describe("I am on Dashboard page and I click 2 times on edit icon of a card", () => {
  ...
  describe("I am on Dashboard and there are no bills", () => {
...
describe("I am connected as Admin, and I am on Dashboard page, and I clicked on a pending bill", () => {
  describe("I click on accept button", () => {
  ...
  describe("I click on refuse button", () => {
    test("I should be sent on Dashboard with big billed icon instead of form", () => {
      Object.defineProperty(window, "localStorage", {
        value: localStorageMock,
      });
...
describe("I am connected as Admin and I am on Dashboard page and I clicked on a bill", () => {
  describe("I click on the icon eye", () => {
...
describe("I am a user connected as Admin", () => {
  describe("I navigate to Dashboard", () => {
